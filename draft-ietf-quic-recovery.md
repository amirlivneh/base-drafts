...
TCP's TLP assumes that if at least 2 packets are outstanding, acks will not be
delayed.
...
or ACN_ECN.  Specifically, implementations MUST attempt to enforce a maximum ack
